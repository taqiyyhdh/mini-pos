...
import { Boxes, LayoutDashboard, LogOut, ReceiptText, ShoppingCart } from "lucide-react";
import { useAuth } from "@/contexts/auth-context";

const menu = [
  { href: "/dashboard", label: "Dashboard", icon: LayoutDashboard },
  { href: "/products", label: "Produk", icon: Boxes },
  { href: "/transactions/new", label: "Kasir / POS", icon: ShoppingCart },
  ...
  return (
    <aside className="border-b border-slate-200 bg-slate-950 text-white lg:min-h-screen lg:w-64 lg:border-b-0 lg:border-r lg:border-slate-800">
      <div className="flex items-center justify-between p-5 lg:block">
        <div>
          <div className="text-xl font-black tracking-tight">MiniPOS</div>
